...
public class Function {
    ...
    private static final String OPEN_WEATHER_MAP_API = "6145028a771a8a03be25a7548fdc23d8";
        ...
        protected void onPostExecute(JSONObject json) {
            try {
                if(json != null){
                   ...
                   // Log.d("ciao", Long.toString(json.getJSONObject("sys").getLong("sunrise") * 1000));
                   // Log.d("ciao1", Long.toString(json.getJSONObject("sys").getLong("sunset") * 1000));
                    //Log.d("ciao2", Integer.toString(details.getInt("id")));
