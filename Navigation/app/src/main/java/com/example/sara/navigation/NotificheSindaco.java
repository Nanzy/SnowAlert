...
public class NotificheSindaco  extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notifiche_sindaco);
        ...
        ora = "11:00";
        data= "23/07/18";
        mex= "Volontario1 ha completato Intervento 1 a Via Roma 13 ore 9:00-10:00";
