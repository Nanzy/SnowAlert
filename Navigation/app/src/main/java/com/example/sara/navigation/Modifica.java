...
public class Modifica extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tText = (TextView) findViewById(R.id.textView2);

        qText = (EditText) findViewById(R.id.editText4);
        ss= b.getString("num");
        qText.setText(ss);
